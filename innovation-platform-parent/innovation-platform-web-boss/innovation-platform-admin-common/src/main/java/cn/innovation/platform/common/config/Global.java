package cn.innovation.platform.common.config;
...
import cn.innovation.platform.common.utils.YamlUtil;
...
public class Global {
	...
	public static String getVersion() {
		return StringUtils.nvl(getConfig("platform.version"), "3.0.0");
	}
	...
	public static String getCopyrightYear() {
		return StringUtils.nvl(getConfig("platform.copyrightYear"), "2018");
	}
	...
	public static String getAuthor() {
		return StringUtils.nvl(getConfig("gen.author"), "mqx");
	}
	...
	public static String getPackageName() {
		return StringUtils.nvl(getConfig("gen.packageName"), "cn.innovation.platform.project.module");
	}
