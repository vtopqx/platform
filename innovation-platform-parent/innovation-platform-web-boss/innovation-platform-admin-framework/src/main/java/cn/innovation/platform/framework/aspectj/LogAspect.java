...
import cn.innovation.platform.common.enums.BusinessStatus;
import cn.innovation.platform.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(cn.innovation.platform.common.annotation.Log)")
